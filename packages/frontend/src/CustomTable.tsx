...
//           <div className="w-full inline-block py-2 align-middle">
//             <div className="overflow-hidden border border-gray-200 dark:border-gray-700 rounded-lg">
//               <div className="divide-y divide-gray-200 dark:divide-gray-700 flex flex-col">
//                 <div className="bg-gray-50 dark:bg-gray-800 flex">
//                   <div className="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400 w-1/4">
//                     <span>Name</span>
//                   </div>
//                   <div className="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400 w-1/4">
//                     <span>Age</span>
...
//                     <span>Team</span>
//                   </div>
//                   <div className="relative py-3.5 px-4 text-right w-1/4">
//                     <span className="sr-only"></span>
//                   </div>
//                 </div>
//                 <div className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
//                   {customers.map((customer, index) => (
//                     <div key={index} className="flex py-4 px-4 text-sm font-medium border-b border-gray-200 dark:border-gray-700">
//                       <div className="max-w-xs w-1/4">
//                         <span className="font-medium text-gray-800 dark:text-white">{customer.name}</span>
//                       </div>
//                       <div className="w-1/4">
//                         <span className="font-medium text-gray-800 dark:text-white">{customer.age}</span>
//                       </div>
//                       <div className="max-w-xs w-1/4">
//                         <span className="font-medium text-gray-800 dark:text-white">{customer.team}</span>
//                       </div>
